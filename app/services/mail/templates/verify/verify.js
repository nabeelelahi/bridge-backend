									...
									<tbody >
										...
										<tr>
											<td colspan="3" height="60" align="center">
												<div border="0" style="border: none; line-height: 60px; color: #ffffff; font-family: Verdana, Geneva, sans-serif; font-size: 52px; text-transform: uppercase; font-weight: bolder;">Welcome To, SecondZoja.com!</div>
											</td>
										</tr>
										<!-- Line 1 -->
										<tr>
															...
															<td align="center">
																<div border="0" style="border: none; height: 60px;">
																	<p style="color:white; font-size: 18px; line-height: 24px; font-family: Verdana, Geneva, sans-serif; color: #ffffff; text-align: center; mso-table-lspace:0;mso-table-rspace:0;">
																		we are happy to have you onboard. we wish you a satisfying journey with secondzoja.com<br/>
                                                                        please click this link below to verify your account<br/>
																				<a href=${
                                          "https://secondzoja.herokuapp.com/www.secondzoja.com/v1/verify-user/" +
                                          data.id
                                        }>${
    "https://secondzoja.herokuapp.com/www.secondzoja.com/v1/verify-user/" + data.id
  }</a>
																	</p>
																</div>
															</td>
