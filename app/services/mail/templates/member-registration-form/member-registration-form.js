...
let memberRegistrationEmail = (data) => {
									...
									<tbody >
										...
										<tr>
											<td colspan="3" height="60" align="center">
												<div border="0" style="border: none; line-height: 60px; color: #ffffff; font-family: Verdana, Geneva, sans-serif; font-size: 52px; text-transform: uppercase; font-weight: bolder;">MEMBER COURSE REGISTRATION FORM</div>
											</td>
										</tr>
										<!-- Line 1 -->
										<tr>
															...
															<td align="center">
																<div border="0" style="border: none; height: 60px;">
																	<p style="color:white; font-size: 18px; line-height: 24px; font-family: Verdana, Geneva, sans-serif; color: #ffffff; text-align: center; mso-table-lspace:0;mso-table-rspace:0;">
																		<br/>
                                                                        please click this link below to register enroll in course by filling this form<br/>
																				<a href=${data.formLink}>${data.formLink}</a>
																	</p>
																</div>
															</td>
															<td width="90" style="width: 9%;"></td>
...
© ${fullYear} all right reserved akumo-solutions.com
</a>
												</div>
											</td>
										</tr>
